...
function cadastrarDespesa() {
  ...
  if(despesa.validarDados()) {
    ...
    document.getElementById('button-modal').innerHTML = 'Voltar e corrigir'
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
  ...
  despesas.forEach(d => {
    ...
    btn.onclick = function() {
      ...
      document.getElementById('modal_conteudo').innerHTML = 'Despesa removida'
      document.getElementById('button-modal-remover').innerHTML = 'voltar'
      document.getElementById('button-modal-remover').className = "btn btn-danger"
      // RESOLVER BUG
      document.getElementById('button-modal-remover').onclick = bd.remover(id)
